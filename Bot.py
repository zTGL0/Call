...
class SolanaCryptoBot:
    ...
    def fetch_solana_pairs(self) -> List[Dict]:
        ...
        try:
            ...
            self.safe_log('info', f"Search method: {len(search_pairs)} pairs")
            
            # 2. Latest token profiles (converted to pairs)
            ...
            if profile_tokens:
                ...
                if token_addresses:
                    ...
                    self.safe_log('info', f"Profile method: {len(profile_pairs)} pairs")
            
            # 3. Boosted tokens (converted to pairs)
            ...
            if boosted_tokens:
                ...
                if token_addresses:
                    ...
                    self.safe_log('info', f"Boosted method: {len(boosted_pairs)} pairs")
